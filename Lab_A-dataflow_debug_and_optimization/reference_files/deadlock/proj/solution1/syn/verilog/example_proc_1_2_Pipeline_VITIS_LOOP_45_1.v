...
module example_proc_1_2_Pipeline_VITIS_LOOP_45_1 (
        ap_clk,
        ap_rst,
        ap_start,
        ap_done,
...
always @ (*) begin
    if (((icmp_ln45_fu_86_p2 == 1'd1) & (1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
...
assign icmp_ln45_fu_86_p2 = ((ap_sig_allocacmp_i_8 == 4'd10) ? 1'b1 : 1'b0);

assign tmp_8_fu_103_p2 = (data_channel121_dout + data_channel232_dout);

endmodule //example_proc_1_2_Pipeline_VITIS_LOOP_45_1
