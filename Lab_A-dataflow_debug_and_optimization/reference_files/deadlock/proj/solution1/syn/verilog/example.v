...
(* CORE_GENERATION_INFO="example_example,hls_ip_2022_1,{HLS_INPUT_TYPE=cxx,HLS_INPUT_FLOAT=0,HLS_INPUT_FIXED=0,HLS_INPUT_PART=xcvu9p-flga2104-2-i,HLS_INPUT_CLOCK=13.333000,HLS_INPUT_ARCH=dataflow,HLS_SYN_CLOCK=3.706000,HLS_SYN_LAT=34,HLS_SYN_TPT=29,HLS_SYN_MEM=0,HLS_SYN_DSP=0,HLS_SYN_FF=580,HLS_SYN_LUT=1178,HLS_VERSION=2022_1}" *)
