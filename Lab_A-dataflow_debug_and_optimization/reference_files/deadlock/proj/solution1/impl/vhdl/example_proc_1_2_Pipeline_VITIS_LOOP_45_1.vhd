...
entity example_proc_1_2_Pipeline_VITIS_LOOP_45_1 is
port (
    ap_clk : IN STD_LOGIC;
    ap_rst : IN STD_LOGIC;
...
architecture behav of example_proc_1_2_Pipeline_VITIS_LOOP_45_1 is 
...
begin
    ...
    add_phi_out_ap_vld_assign_proc : process(ap_CS_fsm_pp0_stage0, icmp_ln45_fu_86_p2, ap_block_pp0_stage0_11001)
    begin
        if (((icmp_ln45_fu_86_p2 = ap_const_lv1_1) and (ap_const_boolean_0 = ap_block_pp0_stage0_11001) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage0))) then 
    ...
    icmp_ln45_fu_86_p2 <= "1" when (ap_sig_allocacmp_i_8 = ap_const_lv4_A) else "0";
